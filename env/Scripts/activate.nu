...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\OJ Ranking\Documents\CODEX\Zuri\Python\Assignments\Django-CRUD\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\OJ Ranking\Documents\CODEX\Zuri\Python\Assignments\Django-CRUD\env\Scripts\deactivate.nu'
